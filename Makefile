...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix spaday_webawesome
	python -m ruff format spaday_webawesome
...
test-py:  ## run python tests
	python -m pytest -v spaday_webawesome/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v spaday_webawesome/tests --cov=spaday_webawesome --cov-report term-missing --cov-report xml
