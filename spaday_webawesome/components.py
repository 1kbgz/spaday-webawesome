    ...
    schema = ComponentSchema(
        ...
        props=(
            ...
            PropertySchema(
                ...
                kind="json",
                choices=(),
                type_text="IconCanvas | undefined",
                default=None,
            ...
            PropertySchema(
                ...
                kind="json",
                choices=(),
                type_text="IconAnimation | undefined",
                default=None,
...
class WaAnimation(Component):
    ...
    schema = ComponentSchema(
        ...
        fields=(
            PropertySchema(name="defaultSlot", kind="json", choices=(), type_text="Promise<HTMLSlotElement>", default=None, description=None),
            PropertySchema(
                name="keyframes",
                kind="json",
                choices=(),
                type_text="Keyframe[] | undefined",
                default=None,
    ...
    schema = ComponentSchema(
        ...
        props=(
            PropertySchema(
                ...
                kind="json",
                choices=(),
                type_text="Element | string | VirtualElement",
                default=None,
    ...
    schema = ComponentSchema(
        ...
        props=(
            ...
            PropertySchema(
                ...
                kind="json",
                choices=(),
                type_text="string | string[] | WaColorPickerSwatch[]",
                default="",
        ...
        fields=(PropertySchema(name="popup", kind="json", choices=(), type_text="WaPopup", default=None, description=None),),
...
class WaCopyButton(Component):
    ...
    schema = ComponentSchema(
        ...
        fields=(
            PropertySchema(name="shadowTooltip", kind="json", choices=(), type_text="WaTooltip", default=None, description=None),
    ...
    schema = ComponentSchema(
        ...
        props=(
            ...
            PropertySchema(
                ...
                kind="json",
                choices=(),
                type_text="WaKnownDateSize | 'small' | 'medium' | 'large'",
                default="m",
            ...
            PropertySchema(
                ...
                kind="json",
                choices=(),
                type_text="WaKnownDateAppearance",
                default="outlined",
...
class WaSelect(Component):
    ...
    schema = ComponentSchema(
        ...
        fields=(
            PropertySchema(name="popup", kind="json", choices=(), type_text="WaPopup", default=None, description=None),
            PropertySchema(name="displayLabel", kind="string", choices=(), default="", description=None),
            PropertySchema(name="currentOption", kind="json", choices=(), type_text="WaOption", default=None, description=None),
            PropertySchema(name="selectedOptions", kind="json", choices=(), type_text="WaOption[]", default=None, description=None),
...
class WaPage(Component):
    ...
    schema = ComponentSchema(
        ...
        fields=(
            PropertySchema(name="navigationDrawer", kind="json", choices=(), type_text="WaDrawer", default=None, description=None),
    ...
    schema = ComponentSchema(
        ...
        props=(
            ...
            PropertySchema(
                ...
                kind="json",
                choices=(),
                type_text="string | ((page: number) => string)",
                default="",
    ...
    schema = ComponentSchema(
        ...
        props=(
            ...
            PropertySchema(
                ...
                kind="json",
                choices=(),
                type_text="(value: number, isSelected: boolean) => string",
                default=None,
...
class WaSlider(Component):
    ...
    schema = ComponentSchema(
        ...
        fields=(PropertySchema(name="tooltip", kind="json", choices=(), type_text="WaTooltip", default=None, description=None),),
        events=("change", "blur", "focus", "input", "wa-invalid"),
    ...
    schema = ComponentSchema(
        ...
        props=(
            ...
            PropertySchema(
                ...
                kind="json",
                choices=(),
                type_text="WaTimeInputSize | 'small' | 'medium' | 'large'",
                default="m",
            ...
            PropertySchema(
                ...
                kind="json",
                choices=(),
                type_text="WaTimeInputHourFormat",
                default="auto",
            ...
            PropertySchema(
                ...
                kind="json",
                choices=(),
                type_text="WaTimeInputPlacement",
                default="bottom-start",
